...
class SimulateurTest {
    ...
    @Test
    void testGetPositionUpdatesScoreWhenBallContainsCar() {
    ...
    void testProcessRequestCrashMaison() {
        ...
        voiture.setPositionX(395);
        voiture.setPositionY(90);

        Simulateur.processRequest("avancer"); // This should trigger a crash with a maison
        assertEquals("0,0", voiture.getPosition()); // Assuming initial position is (0,0) and carburant is 100 and score
                                                    // is reset to 0
    }
    ...
    void testProcessRequestRecharge() {
        ...
        assertEquals(100, voiture.getCarburant()); // Assuming initial position is (0,0) and carburant is 100 and score
                                                   // is 0
    }
}
